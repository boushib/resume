        ...
        <form action="create-resume" method="post">
          <div class="step active">
            ...
            <div class="form-control">
              ...
              <input type="text" name="job_title" id="job_title" placeholder="Enter your job title" required>
            </div>
            <div class="form-control">
          ...
          <div class="step">
            <div class="form-control">
              ...
              <textarea name="professional_experience" id="professional_experience" required></textarea>
            </div>
          </div>
          <div class="step">
            <div class="form-control">
